package com.mrs.engagement_service.exception;

import com.mrs.engagement_service.exception.application.EngagementApplicationException;
import com.mrs.engagement_service.exception.domain.interaction.InteractionDomainException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EngagementApplicationException.class)
    public ResponseEntity<ApiResponseError> handleEngagementApplicationException(
            EngagementApplicationException ex, HttpServletRequest request) {

        HttpStatus status = HttpStatus.BAD_REQUEST;
        return ResponseEntity.status(status).body(ApiResponseError.builder()
                .status(status.value())
                .error("Engagement Application Error")
                .message(ex.getMessage())
