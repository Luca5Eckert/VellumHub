...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(RecommendationDomainException.class)
    public ResponseEntity<ApiResponseError> handleRecommendationDomainException(
            RecommendationDomainException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(RecommendationApplicationException.class)
    public ResponseEntity<ApiResponseError> handleRecommendationApplicationException(
            RecommendationApplicationException ex, HttpServletRequest request) {

        HttpStatus status = HttpStatus.BAD_REQUEST;
        return ResponseEntity.status(status).body(ApiResponseError.builder()
                .status(status.value())
                .error("Recommendation Application Error")
                .message(ex.getMessage())
