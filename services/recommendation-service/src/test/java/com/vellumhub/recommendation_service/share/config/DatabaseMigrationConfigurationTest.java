...
class DatabaseMigrationConfigurationTest {
    ...
    void initialFlywayMigrationIsPackaged() throws IOException {
        ...
        assertThat(migration)
                ...
                .contains("CREATE TABLE book_features")
                .contains("CREATE TABLE user_profiles")
                .contains("CREATE TABLE recommendations");
    }
    ...
    @Test
    void h2TestProfileDoesNotRunPostgresMigrations() throws IOException {
