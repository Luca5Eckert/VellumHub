...
class DatabaseMigrationConfigurationTest {
    ...
    void initialFlywayMigrationIsPackaged() throws IOException {
        ...
        assertThat(migration)
                ...
                .contains("CREATE TABLE book_requests")
                .contains("CREATE TABLE book_progress")
                .contains("CREATE TABLE book_lists");
    }
    ...
    @Test
    void h2ProfilesDoNotRunPostgresMigrations() throws IOException {
        assertThat(loadProperties("application-local.properties").getProperty("spring.flyway.enabled")).isEqualTo("false");
        assertThat(loadProperties("application-test.properties").getProperty("spring.flyway.enabled")).isEqualTo("false");
    }
