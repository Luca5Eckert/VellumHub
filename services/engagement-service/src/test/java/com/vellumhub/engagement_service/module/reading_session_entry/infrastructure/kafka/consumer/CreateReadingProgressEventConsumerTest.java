...
class CreateReadingProgressEventConsumerTest {
    ...
    @InjectMocks
    private CreateReadingProgressEventConsumer consumer;

    @Captor
    private ArgumentCaptor<CreateReadingSessionEntryCommand> commandCaptor;

    @Test
    @DisplayName("Should map create progress event IDs to the reading session command")
    void shouldMapCreateProgressEventIdsToCommand() {
        ...
        assertThat(command.pageRead()).isEqualTo(12);
    }
}
